...
function SmallGame({ imgUrl, gameName, price }) {
  return (
    <div className='flex justify-between p-1 sm:justify-around sm:max-w-[357px] sm:max-h-[200px] rounded-lg cursor-pointer border-2 border-transparent hover:border-gray-400 transition-all duration-250'>
      <div className=''>
        <img
          src={imgUrl}
      ...
      <div className='flex flex-col mt-5 gap-1 ml-2 items-end'>
        <h4 className='poppins text-white text-2xl sm:text-lg'>{gameName}</h4>
