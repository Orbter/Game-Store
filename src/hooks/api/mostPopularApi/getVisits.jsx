const getVisits = () => {
  fetch('https://api.igdb.com/v4/popularity_primitives/', {
    ...
    body: 'fields game_id, value;sort value desc;limit 100;where popularity_type = 1;', // convert data to JSON format for the body
  })
    .then((response) => {
      if (!response.ok) {
    ...
    .then((data) => {
      console.log('Success Visits:', data); // handle the successful response data
    })
    .catch((error) => {
